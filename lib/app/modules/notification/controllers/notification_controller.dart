...
import 'package:roadside_assistance/app/modules/notification/model/notification_response.dart';
import 'package:roadside_assistance/common/prefs_helper/prefs_helpers.dart';

class NotificationController extends GetxController {

  final NetworkCaller _networkCaller = NetworkCaller.instance;
  Rx<NotificationResponse> notificationResponse = NotificationResponse().obs;
  ...
  Future<void> fetchNotification() async {
    ...
    try {
      ...
      if (response.isSuccess && response.data != null) {
        ...
        print(responseData);
        notificationResponse.value = NotificationResponse.fromJson(responseData ?? {});
  ...
  Future<void> makePayment({String? orderId,VoidCallback? callBack}) async {
    String token = await PrefsHelper.getString('token');
    final body ={
