            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Request ID ${orderDetailItems?.result?.uniqueOrderId??''}',
                      style: TextStyle(
                        fontSize: 16.sp,
                        fontWeight: FontWeight.w600,
                    ...
                    Row(
                      children: [
                        CircleAvatar(
                          ...
                          backgroundImage: NetworkImage(orderDetailItems?.result?.user?.image??''),
                        ),
                        SizedBox(width: 12.w),
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              /// user Name
                              Text(orderDetailItems?.result?.user?.name??'',
                                style: TextStyle(
                                  fontSize: 16.sp,
                                  fontWeight: FontWeight.w600,
                                  color: Colors.black87,
                              ...
                              SizedBox(height: 2.h),
                              Text(
                                orderDetailItems?.result?.user?.email??'',
                                style: TextStyle(
                                  fontSize: 14.sp,
                        ...
                        CustomButton(
                            ...
                            height: 45.h,
                            onTap: (){
                              Get.toNamed(Routes.MESSAGEINBOX,arguments: {"receiverId":orderDetailItems?.result?.user?.id??''});
                            }, text: 'Message'),
                      ],
                    ),
                  ],
              ...
              _buildSection(
                ...
                child: Column(
                  children: [
                    _buildDetailRow('Brand', orderDetailItems?.result?.vehicle?.brand??''),
                    SizedBox(height: 12.h),
                    _buildDetailRow('Model', orderDetailItems?.result?.vehicle?.model??''),
                    // SizedBox(height: 12.h),
                    // _buildDetailRow('Year', '2017'),
                    SizedBox(height: 12.h),
                    _buildDetailRow('License Plate', orderDetailItems?.result?.vehicle?.number??''),
                  ],
                ),
              ),
              ...
              _buildSection(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4.h),
                    Text(
                      '${orderDetailItems?.result?.address??''}\n${orderDetailItems?.result?.streetNo??''}',
                      style: TextStyle(
                        fontSize: 13.sp,
                        color: Colors.grey[600],
                        height: 1.4,
                ...
                child: Column(
                  ...
                  children: [
                   ...
                   final serviceItem = orderDetailItems?.mechanicServiceRate?.services?[index];
                     return _buildDetailRow(serviceItem?.service?.name??'', serviceItem?.price.toString()??'');
                   }),
                    _buildDetailRow('App Service charge', orderDetailItems?.appService.toString()??''),
                  Divider(height: 2,color: Colors.grey,),
                  _buildDetailRow('Total', orderDetailItems?.result?.total.toString()??''),
                    SizedBox(height: 12.h),
                    Text(
                      'Customer Notes',
                      style: TextStyle(
                    ...
                    SizedBox(height: 8.h),
                    Text(
                      orderDetailItems?.result?.additionalNotes??'',
                      style: TextStyle(
                        fontSize: 14.sp,
                        color: Colors.grey[600],
                        height: 1.4,
